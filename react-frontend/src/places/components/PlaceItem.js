...
const PlaceItem = (props) => {
  const { isLoggedIn, error, sendRequest, clearError } = useHttpClient();
  ...
  const cancelDeleteWarmingHandler = () => {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <h5> Plase not it can't be undone therafter.</h5>
      </Modal>
      <li className='place-item'>
        <Card className='place-item__content'>
          {isLoggedIn && <LoadingSpinner asOverlay />}
